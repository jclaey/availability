...
console.log(JSON.parse(localStorage.getItem('availability')).filter(employee => employee.firstName === 'Jason' && employee.lastName === 'Claeys').length > 0)
...
form.addEventListener('submit', e => {
    ...
    // if (availability.filter(employee => employee.firstName === firstName.value && employee.lastName === lastName.value).length > 0) {
